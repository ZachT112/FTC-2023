...
@Autonomous(name = "Updated Left", group = "2023")
public class UpdatedLeft extends UpdatedAutonomousController {
    public static final COLORS DEFAULT_COLOR = COLORS.MAGENTA;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        setLiftPosition(0);
        waitForLift();
        forward(1100 * (COLORS.values().length - 1 - color.ordinal()));
    }
